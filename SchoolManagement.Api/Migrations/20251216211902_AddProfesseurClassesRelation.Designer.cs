...
namespace SchoolManagement.Api.Migrations
{
    ...
    [Migration("20251216211902_AddProfesseurClassesRelation")]
    partial class AddProfesseurClassesRelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SchoolManagementSystem.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdAccount = 1,
                            Actif = true,
                            DateCreation = new DateTime(2025, 12, 16, 22, 19, 1, 252, DateTimeKind.Local).AddTicks(5398),
                            PasswordHash = "$2a$11$SNB.1mOyHcDqPwMaNpgfDODYLt8o5fjQe2kaPJBSGjfA.6u4VWsUa",
                            Role = "Admin",
            ...
            modelBuilder.Entity("SchoolManagementSystem.Models.Classe", b =>
                {
                    ...
                    b.Property<int?>("ProfesseurIdProf")
                        .HasColumnType("int");

                    b.HasKey("IdClasse");

                    b.HasIndex("ProfesseurIdProf");
            ...
            modelBuilder.Entity("SchoolManagementSystem.Models.Classe", b =>
                {
                    b.HasOne("SchoolManagementSystem.Models.Professeur", null)
                        .WithMany("Classes")
                        .HasForeignKey("ProfesseurIdProf");
                });
